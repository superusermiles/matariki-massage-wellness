...
const bookingMethods = [
  {
    ...
    copy:
      "Use the enquiry form below to send your preferred treatment, ideal time, and any pregnancy, injury, or voucher notes directly through the site. Once submitted, you’ll be taken to a confirmation page.",
    href: "#enquiry-form",
    label: "Jump to enquiry form",
  },
  {
    ...
    <main>
      <section className="py-16 md:py-24">
        <div className="section-shell grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
          ...
          <div className="card-surface soft-shadow rounded-[28px] p-8 md:p-10">
            ...
            <h2 className="mt-4 text-4xl">Choose the easiest way to book your Mount Maunganui massage.</h2>
            <p className="mt-4 leading-8 text-[rgba(31,36,48,0.74)]">
              You can enquire online, email, or call directly, depending on how you prefer to organise your appointment.
            </p>
            ...
            <div className="mt-6 rounded-[18px] bg-[var(--sand)] px-5 py-4 text-sm leading-7 text-[rgba(31,36,48,0.76)]">
              The online enquiry form redirects to a dedicated thank-you page once your message is sent, so you know it has gone through.
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="enquiry-form" className="bg-white py-20 md:py-24">
        <div className="section-shell grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-[var(--moss)]">Online enquiry form</p>
            <h2 className="mt-4 text-4xl md:text-5xl">Send your booking request through the site.</h2>
            <p className="mt-5 text-lg leading-8 text-[rgba(31,36,48,0.74)]">
              Share your preferred treatment, ideal timing, and any context that will help tailor your session. After you submit, the site will take you straight to the thank-you page.
            </p>
            <div className="mt-8 media-shadow overflow-hidden rounded-[28px]">
              <img
          ...
          <div className="card-surface soft-shadow rounded-[28px] p-8 md:p-10">
            <p className="text-sm uppercase tracking-[0.24em] text-[var(--clay)]">Hosted form</p>
            <h3 className="mt-4 text-3xl text-[var(--night)]">Tell us what you need.</h3>
            <p className="mt-4 leading-8 text-[rgba(31,36,48,0.74)]">
              Include anything useful such as injury notes, pregnancy support, gift voucher questions, or timing preferences.
            </p>
            <ContactForm />
          </div>
        </div>
      ...
      <section className="py-20 md:py-24">
        <div className="section-shell grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-4xl md:text-5xl">Easy to arrive for your Mount Maunganui massage, easy to settle.</h2>
            <p className="mt-5 text-lg leading-8 text-[rgba(31,36,48,0.74)]">
          ...
          <div className="media-shadow overflow-hidden rounded-[28px]">
            <img
              src="https://images.unsplash.com/photo-1515377905703-c4788e51af15?w=1000&h=800&fit=crop"
              alt="Wellness consultation and booking notes for a massage appointment"
              className="h-[420px] w-full object-cover"
            />
          </div>
        </div>
